...
public:
    ...
    float calculatepayment() { return 2000.0; }
};
...
public:
    ...
    float calculatepayment() { return 4000 + years * 100; }
};
...
public:
    ...
    : professor(n, a, i, c, d, s, y) {}
    float calculatepayment() { return 6000 + years * 200; }
};
...
public:
    ...
    : professor(n, a, i, c, d, s, y) {}
    float calculatepayment() { return 8000 + years * 300; }
};
